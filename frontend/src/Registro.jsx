    ...
    <div className="relative min-h-screen overflow-hidden  ">
      ...
      <div className="app-container relative top-[80px] left-[490px]">
        <div className="text-center">
          ...
          <a target="_blank" rel="noopener noreferrer"> {/*href="https://www.chivasdecorazon.com.mx/es"*/}
        ...
        <div className="card max-w-md mx-auto bg-white/10 backdrop-blur-md p-6 rounded-lg">
             {/* Nombre, correo, contraseña, pais, numero, cumpleaños
         Tabla de calendar y country*/}
         {/* 1 Nombre, correo, contraseña, contraseña pais, 
          en settings numero, cumpleaños*/}
            <form onSubmit={handleSubmit}>
            <div className = ''>
                <label htmlFor= "nombre"><strong></strong></label>
                <input type="text" placeholder='Nombre' name = 'nombre'
                onChange={e => setValues({...values,nombre:e.target.value})}className = 'rounded bg-white w-full py-2 px-4'/>
